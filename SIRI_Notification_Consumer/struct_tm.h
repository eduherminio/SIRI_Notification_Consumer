/*
	...
	Custom serializer for <time.h> struct xsd__dateTime__ as xsd:dateTime
...
namespace GSOAP
{
	xsd__dateTime from_ptime(const boost::posix_time::ptime& p);
	boost::posix_time::ptime to_ptime(const xsd__dateTime& dt);
}